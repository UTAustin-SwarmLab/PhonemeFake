...
def main():
    parser = argparse.ArgumentParser(description = 'ITW Dataset evaluation')
    parser.add_argument("--protocol_path", type=str, 
                        help="protocol file path",
                        required=True, default=None)
    parser.add_argument("--wav_path", type=str,
                        help="wav file path",
                        required=True, default=None)
    parser.add_argument("--model_folder", type=str, help="models folder", required=False, default='./models')
    parser.add_argument("-e", "--eval_output", type=str, help="score file destination", required=False, default="./scores/ITW_eval.txt")
    ...
    eval_set=Dataset_ITW_eval(list_IDs = file_eval, base_dir = args.wav_path)
    device = "cuda"
    dtype = torch.float32
    ...
    model.load_state_dict(torch.load(os.path.join(args.model_folder, 'rawbmamba_v1.pt'), map_location='cuda:0'))
