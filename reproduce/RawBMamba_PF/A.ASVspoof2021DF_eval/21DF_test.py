...
def main():
    ...
    parser.add_argument("--wav_path", type=str,
                        help="wav file path",
                        required=True, default=None)
    parser.add_argument("--model_folder", type=str, help="output folder", required=False, default='./models')
    ...
    model.load_state_dict(torch.load(os.path.join(args.model_folder, 'rawbmamba_best.pt'), map_location='cuda:0'))
